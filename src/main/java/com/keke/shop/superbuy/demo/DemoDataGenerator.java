package com.keke.shop.superbuy.demo;
...
public class DemoDataGenerator implements ModelDataJsonConstants {
  ...
  protected void initDemoGroups() {
    String[] assignmentGroups = new String[] {"management", "sales", "marketing", "engineering","deptLeader"};
  ...
  protected void initDemoUsers() {
    ...
    createUser("gonzo", "Gonzo", "The Great", "gonzo", "gonzo@activiti.org", 
            ...
            Arrays.asList("management", "sales", "marketing", "user","deptLeader"),
            null);
