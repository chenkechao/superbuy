...
<script type="text/javascript">
	...
	function createOrg() {
		$('#mainIframe', $(parent.document)).attr("src",
				'${ctx }/security/org/create');
	}

	function viewOrg(orgId) {
		$('#mainIframe', $(parent.document)).attr("src",
				"${ctx}/security/org/view/" + orgId);
	}
	
	function viewOrg(orgId) {
		$('#mainIframe', $(parent.document)).attr("src",
				"${ctx}/security/org/update/" + orgId);
	}

	function deleteOrg(orgId) {
		$.ajax({
			url : "${ctx}/security/org/delete/" + orgId,
			cache : false,
				...
				<div class="row">
					<div class="col-md-12">
						<div id="toolbar" class="fixed-table-toolbar"
							...
							<button id="createOrg" type="button" class="btn btn-primary"
								onClick="createOrg()">新建</button>
						...
						<table class="table table-striped table-bordered table-hover"
							...
							data-url="${ctx }/security/org/list/json"
							...
							<thead>
								<tr>
									...
									<!-- 
									<th data-field="parentOrg.name">上级部门名称</th> -->
