...
<body>
	<form id="inputForm" action="${ctx }/security/resource/update"
		method="post">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<tr>
				...
				<td class="td_table_2"><input type="text" class="input_240"
					id="name" name="name" value="${resource.name }" /></td>
				<td class="td_table_1"><span>资源值：</span></td>
				<td class="td_table_2"><input type="text" class="input_240"
					id="source" name="source" value="${resource.source }" /></td>
			</tr>
			<tr>
				<td class="td_table_1"><span>所属菜单：</span></td>
				<td class="td_table_2" colspan="3"><input type="hidden"
					id="parentMenuId" name="parentMenuId" value="${resource.menu.id }">
					<input type="text" id="parentMenuName" readonly="readonly"
					name="parentMenuName" class="input_240"
					value="${resource.menu.name }"> <input type='button'
					class='button_70px' value='选择菜单' id="selectMenu"
					onclick="openMenu()" /></td>
			</tr>
		</table>
