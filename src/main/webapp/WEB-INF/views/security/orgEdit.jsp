		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<tr>
				...
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" id="name" name="name" value="${org.name }" /></td>
			</tr>
			<tr>
				<td class="td_table_1"><span>上级部门：</span></td>
				<td class="td_table_2" colspan="3"><input type="hidden"
					id="parentOrgId" name="parentOrgId" value="${org.parentOrg.id }">
					<input type="text" id="parentOrgName" readonly="readonly"
					name="parentOrgName" class="input_240"
					value="${org.parentOrg.name }"> <input type='button'
					class='button_70px' value='上级部门' id="selectOrgBtn"
					onclick="openOrg()" /></td>
			</tr>
			<tr>
				<td class="td_table_1"><span>部门描述：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_520" id="description" name="description"
					value="${org.description }"></td>
			</tr>
		</table>
