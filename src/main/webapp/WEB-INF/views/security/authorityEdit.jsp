...
<body>
	<form id="inputForm" action="${ctx }/security/authority/update"
		method="post">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<tr>
				...
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" id="name" name="name" value="${authority.name }" />
				</td>
			</tr>
			<tr>
				<td class="td_table_1"><span>权限描述：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" id="description" name="description"
					value="${authority.description }" /></td>
			</tr>
		</table>
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<tr>
				...
				<td align=center width=45% class="td_list_1" nowrap><a
					href="javascript:sort('name','asc')">资源名称</a></td>
				<td align=center width=45% class="td_list_1" nowrap><a
					href="javascript:sort('source','asc')">资源</a></td>
			</tr>
			<c:forEach items="${resources}" var="resource">
				<tr>
					<td class="td_list_2" align=center nowrap><label
						class="checkbox"> <input type="checkbox"
							name="orderIndexs" value="${resource.id}"
							${resource.selected== 1 ? 'checked' : '' }>
					</label></td>
