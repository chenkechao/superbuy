...
<body>
	<form id="inputForm" action="${ctx }/security/role/update"
		method="post">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<tr>
				<td class="td_table_1"><span>角色名称：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" id="name" name="name" value="${role.name }" /></td>
			</tr>
			<tr>
				<td class="td_table_1"><span>角色描述：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			cellspacing="0">
			<tr>
				<td align=center width=30% class="td_list_1" nowrap><input
					type="checkbox" title="全选" id="selectAll"></td>
				<td align=center width=70% class="td_list_1" nowrap><a
					href="javascript:sort('name','asc')">权限名称</a></td>
			</tr>
			<c:forEach items="${authorities}" var="authority">
				<tr>
					<td class="td_list_2" align=center nowrap><label
						class="checkbox"> <input type="checkbox"
							name="orderIndexs" value="${authority.id}"
							${authority.selected== 1 ? 'checked' : '' }>
					</label></td>
