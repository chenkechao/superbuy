...
<body>
	<form id="inputForm" action="${ctx }/security/menu/update"
		method="post">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<tr>
				<td class="td_table_1"><span>菜单名称：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" id="name" name="name" value="${menu.name }" /></td>
			</tr>
			<tr>
				<td class="td_table_1"><span>上级菜单：</span></td>
				<td class="td_table_2" colspan="3"><input type="hidden"
					id="parentMenuId" name="parentMenuId"
					value="${menu.parentMenu.id }"> <input type="text"
					id="parentMenuName" readonly="readonly" name="parentMenuName"
					class="input_240" value="${menu.parentMenu.name }"> <input
					type='button' class='button_70px' value='上级菜单' id="selectMenu"
					onclick="openMenu()" /></td>
			</tr>
			<tr>
				<td class="td_table_1"><span>排序值：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" id="orderby" name="orderby"
					value="${menu.orderby }" /></td>
			</tr>
		</table>
