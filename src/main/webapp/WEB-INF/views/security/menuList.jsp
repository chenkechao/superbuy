...
<script type="text/javascript">
	...
	function createMenu() {
		$('#mainIframe', $(parent.document)).attr("src",
				'${ctx }/security/menu/create');
	}

	function viewMenu(menuId) {
		$('#mainIframe', $(parent.document)).attr("src",
				"${ctx}/security/menu/view/" + menuId);
	}
	
	function viewMenu(menuId) {
		$('#mainIframe', $(parent.document)).attr("src",
				"${ctx}/security/menu/update/" + menuId);
	}

	function deleteMenu(menuId) {
		$.ajax({
			url : "${ctx}/security/menu/delete/" + menuId,
			cache : false,
				...
				<div class="row">
					<div class="col-md-12">
						<div id="toolbar" class="fixed-table-toolbar"
							...
							<button id="createMenu" type="button" class="btn btn-primary"
								onClick="createMenu()">新建</button>
						...
						<table class="table table-striped table-bordered table-hover"
							...
							data-url="${ctx }/security/menu/list/json"
