...
<body>
	<form id="mainForm" action="${ctx}/security/resource" method="get">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<tr>
				<td class="td_table_1"><span>资源名称：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" name="filter_LIKES_name"
					value="${param['filter_LIKES_name']}" /></td>
			</tr>
		</table>
		<table align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left"><shiro:hasPermission name="RESOURCEEDIT">
						<input type='button'
							onclick="addNew('${ctx}/security/resource/create')"
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			cellspacing="0">
			<tr>
				<td align=center width=20% class="td_list_1" nowrap>资源名称</td>
				<td align=center width=20% class="td_list_1" nowrap>资源值</td>
			...
			<c:forEach items="${page.result}" var="resource">
				<tr>
					...
					<td class="td_list_2" align=left nowrap><shiro:hasPermission
							name="ORGDELETE">
							<a href="${ctx}/security/resource/delete/${resource.id }"
								class="btnDel" title="删除" onclick="return confirmDel();">删除</a>
						</shiro:hasPermission> <shiro:hasPermission name="RESOURCEDELETE">
							<a href="${ctx}/security/resource/update/${resource.id }"
								class="btnEdit" title="编辑">编辑</a>
						</shiro:hasPermission> <a href="${ctx}/security/resource/view/${resource.id }"
