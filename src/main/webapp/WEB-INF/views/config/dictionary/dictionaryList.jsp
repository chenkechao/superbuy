...
<body>
	<form id="mainForm" action="${ctx}/config/dictionary?lookup=${lookup }"
		method="get">
			...
			<tr>
				<td align="left"><c:choose>
						<c:when test="${empty lookup}">
							<input type='button'
								onclick="addNew('${ctx}/config/dictionary/create')"
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			cellspacing="0">
			<tr>
				<td align=center width=45% class="td_list_1" nowrap>配置名称</td>
				<td align=center width=45% class="td_list_1" nowrap>显示名称</td>
