...
<body>
	<form id="inputForm" action="${ctx }/config/dictionary/update"
		method="post">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<tr>
				<td class="td_table_1"><span>配置名称：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" id="name" name="name" value="${dictionary.name }" />
				</td>
			</tr>
			<tr>
				<td class="td_table_1"><span>显示名称：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" id="cnName" name="cnName"
					value="${dictionary.cnName }" /></td>
			</tr>
			<tr>
				<td class="td_table_1"><span>配置描述：</span></td>
				<td class="td_table_2" colspan="3"><input type="text"
					class="input_240" id="description" name="description"
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			cellspacing="0">
			<tr>
				<td class="td_table_1"><span>添加选项：</span></td>
				<td class="td_table_2" colspan="3"><input type="button"
					class="button_70px" value="添加选项" onclick="addItem()"></td>
			</tr>
			<tr>
				<td class="td_table_1"><span>选项列表：</span></td>
				<td class="td_table_2" colspan="3">
					<table class="table_all" align="center" border="0" cellpadding="0"
						cellspacing="0" id="itemTable" style="margin: 0">
						<tr>
							<td align=center width=15% class="td_list_1" nowrap>序号</td>
							<td align=center width=25% class="td_list_1" nowrap>编号</td>
							<td align=center width=60% class="td_list_1" nowrap>名称</td>
							<td align=center width=10% class="td_list_1" nowrap>操作</td>
						</tr>
						<c:forEach var="item" items="${dictionary.dictionaryItems}"
							varStatus="s">
							<tr>
								<td class="td_list_2"><input type="text"
									value="${item.orderby }" name='orderbys' size="2"></td>
								<td class="td_list_2"><input type="text"
									value='${item.code }' name='codes' class='input_50'></td>
								<td class="td_list_2"><input type="text"
									value='${item.name }' name='itemNames' class='input_520'>
								</td>
								<td class="td_list_2"><a href='javascript:void(0)'
									onclick='delRow(${item.orderby})' class='btnDel' title='删除'>删除</a>
								</td>
							</tr>
